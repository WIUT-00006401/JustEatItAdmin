...
import com.example.justeatitadmin.Adapter.MyAddonAdapter
import com.example.justeatitadmin.Adapter.MySizeAdapter
...
class SizeAddonEditActivity : AppCompatActivity() {
    ...
    private fun saveData() {
        if (foodEditPosition != -1)
        {
            ...
            FirebaseDatabase.getInstance()
                ...
                .addOnFailureListener{e: Exception -> Toast.makeText(this@SizeAddonEditActivity,""+e.message,
    ...
    fun onSizeModelUpdate(event:UpdateSizeModel)
    {
        ...
        {
            needSave = true
            Common.foodSelected!!.size = event.sizeModelList!! //Event
    ...
    fun onAddonModelUpdate(event: UpdateAddonModel)
    {
        ...
        {
            needSave = true
            Common.foodSelected!!.addon = event.addonModelList!! //Event
        }
    }
